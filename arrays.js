...
2
function calculateTotalSalary(customers) {
  return customers.reduce((total, customer) => total + parseFloat(customer.salary), 0);
};

3

function filterUsersByFriendCount(users) {
  return users.filter(user => user.friends.length >=8);
};

4
function collectAllFriends(users) {
...
console.log(sortUsersByFirstName(customersSalary));
